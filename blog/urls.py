...
schema_view = get_schema_view(
   openapi.Info(
      ...
      default_version='v1',  
      description="""This project is a blog API built using Django Rest Framework. 
      It provides a RESTful API for creating, reading, updating, and deleting blog posts.
